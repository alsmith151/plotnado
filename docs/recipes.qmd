...
![Autocolor and color groups](images/aesthetics/autocolor.png)
...
More rendered runnable outputs, including quickstart, links/hline/vline, and gene-label examples, are collected in the [Living Gallery](example_coverage.qmd).
