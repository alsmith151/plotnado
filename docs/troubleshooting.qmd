...
![Overlay troubleshooting output](images/aesthetics/overlay_autoscale.png)
...
Then compare with [Aesthetics Reference](aesthetics_reference.qmd) and [Reference](reference.qmd).
