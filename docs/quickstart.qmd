...
![Ready-made quickstart script output](images/examples/quickstart_first_plot.png)
...
![Template-rendered quickstart output](images/examples/quickstart_first_plot.png)
...
![Python-loaded template output](images/examples/quickstart_first_plot.png)
...
- Learn all track-add patterns: [Track Construction](quickstart_tracks.qmd)
- Learn the template workflow: [CLI](cli.qmd)
- Review practical defaults: [Best Practices](best_practices.qmd)
- Explore track families: [Track Catalog](track_catalog.qmd)
- See a longer executable walkthrough: [Worked Examples](worked_examples.qmd)
