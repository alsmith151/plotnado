...
![CLI plot output](images/examples/quickstart_first_plot.png)
...
![Additional CLI plot output](images/examples/quickstart_first_plot.png)
...
![Python bridge output](images/examples/quickstart_first_plot.png)
