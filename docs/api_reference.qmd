...
- Generated module/class reference: [Reference Summary](reference/SUMMARY.qmd)
- Auto-generated options reference for every track: [Aesthetics Reference](aesthetics_reference.qmd)
...
If you want a browsable summary rather than runtime output, start with [Aesthetics Reference](aesthetics_reference.qmd).
...
![Helper method output](images/quickstart.png)
...
![Color group helper output](images/aesthetics/autocolor.png)
...
For practical usage, prefer [Quick Start](quickstart.qmd), [Track Catalog](track_catalog.qmd), and [Recipes](recipes.qmd).
