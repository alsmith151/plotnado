...
```{python}
#| fig-cap: "A window of 50 bins visibly smooths noisy signal while preserving peak position; `median` smoothing is more robust to spikes, and with a large window it can produce flat-topped peaks by design."
from plotnado import GenomicFigure
from plotnado.examples import REGION, signal
